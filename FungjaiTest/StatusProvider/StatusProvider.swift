...
extension StatusProvider{
    ...
    public func show(statusType type: StatusProviderType){
        ...
        case let .error(error,retry):
            ...
            (statusView as? ErrorStatusDisplaying)?.postition = loadingView?.bounds
        ...
        case let .empty(action):
            ...
            (statusView as? EmptyStatusDisplaying)?.postition = loadingView?.bounds
